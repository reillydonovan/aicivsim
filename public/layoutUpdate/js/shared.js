...
/* ================================================================
   VIZ_SYS — canonical 3D system data for viz.html/xr.html
   Moved from duplication in viz.html and xr.html into shared.js.
   Consumers: viz.html, xr.html. Use window.VIZ_SYS / window.VIZ_SUB_NODE_DATA / window.VIZ_SUB_SUB_NODE_DATA
   ================================================================ */
var VIZ_SYS=[
  {id:'climate',     label:'Climate',      color:0x4ecdc4, today:42, proj:{aggressive:85,moderate:58,bau:28,worst:12},  href:'climate.html', desc:'Planetary systems — temperature, emissions, biodiversity, ocean health, renewable energy, crop yields, water stress, and tipping point risk.'},
  {id:'simulation',  label:'Simulation',   color:0x5da5da, today:50, proj:{aggressive:90,moderate:70,bau:35,worst:15},  href:'simulation.html', desc:'The interactive engine — 5 policy levers, 50-year timeline, era-phased narrative reports from possible futures.'},
  {id:'transition',  label:'Transition',   color:0x95cf95, today:43, proj:{aggressive:88,moderate:68,bau:28,worst:12},  href:'transition.html', desc:'Workforce readiness — reskilling rates, poverty trajectories, income bridge calculator, employment metrics.'},
  {id:'ai',          label:'AI',             color:0xe8a838, today:48, proj:{aggressive:92,moderate:68,bau:32,worst:10},  href:'ai.html', desc:'Artificial intelligence — alignment progress, autonomy risk, compute governance, model transparency, and deployment safety.'},
  {id:'governance',  label:'Governance',   color:0xb0a0d0, today:40, proj:{aggressive:85,moderate:65,bau:30,worst:10},  href:'governance.html', desc:'Institutional infrastructure — civic participation, AI charter adoption, citizen assemblies, safety audit coverage.'},
  {id:'strategy',    label:'Strategy',     color:0xe8636e, today:35, proj:{aggressive:88,moderate:62,bau:22,worst:8},   href:'strategy.html', desc:'The action catalog — 20+ strategies across individual, institutional, and systemic implementation levels.'}
];
var VIZ_SC_META={
...
var VIZ_SUB_NODE_DATA={
  climate:[{id:'temp',label:'Temperature',color:0x4ecdc4,today:58,proj:{aggressive:92,moderate:68,bau:35,worst:15}},{id:'emissions',label:'Emissions',color:0xd4622a,today:32,proj:{aggressive:95,moderate:60,bau:22,worst:8}},{id:'energy',label:'Energy',color:0x5da5da,today:45,proj:{aggressive:96,moderate:72,bau:38,worst:18}},{id:'bio',label:'Biodiversity',color:0x4ecdc4,today:40,proj:{aggressive:88,moderate:58,bau:20,worst:8}},{id:'ocean',label:'Ocean Health',color:0x9b87f5,today:35,proj:{aggressive:80,moderate:52,bau:18,worst:6}},{id:'resource',label:'Resources',color:0x95cf95,today:42,proj:{aggressive:78,moderate:55,bau:30,worst:12}}],
  ai:[{id:'alignment',label:'Alignment',color:0xe8a838,today:48,proj:{aggressive:92,moderate:68,bau:32,worst:10}},{id:'transparency',label:'Transparency',color:0x4ecdc4,today:15,proj:{aggressive:97,moderate:61,bau:12,worst:3}},{id:'safety',label:'Safety',color:0xd4622a,today:35,proj:{aggressive:90,moderate:62,bau:28,worst:10}},{id:'compute',label:'Compute Gov.',color:0x5da5da,today:20,proj:{aggressive:85,moderate:52,bau:18,worst:5}},{id:'autonomy',label:'Autonomy',color:0x9b87f5,today:62,proj:{aggressive:88,moderate:70,bau:40,worst:15}},{id:'trust',label:'Public Trust',color:0x95cf95,today:30,proj:{aggressive:82,moderate:55,bau:22,worst:8}}],
  simulation:[{id:'gini',label:'Inequality',color:0x5da5da,today:62,proj:{aggressive:87,moderate:70,bau:38,worst:15}},{id:'trust',label:'Trust',color:0x4ecdc4,today:43,proj:{aggressive:78,moderate:64,bau:32,worst:12}},{id:'emis',label:'Emissions',color:0xd4622a,today:30,proj:{aggressive:82,moderate:55,bau:22,worst:8}},{id:'resil',label:'Resilience',color:0x95cf95,today:36,proj:{aggressive:73,moderate:56,bau:30,worst:10}},{id:'aiinf',label:'AI Influence',color:0xe8a838,today:12,proj:{aggressive:40,moderate:30,bau:15,worst:5}}],
  transition:[{id:'poverty',label:'Poverty',color:0xd4622a,today:37,proj:{aggressive:88,moderate:72,bau:28,worst:10}},{id:'reskill',label:'Reskill Time',color:0x5da5da,today:32,proj:{aggressive:86,moderate:65,bau:25,worst:8}},{id:'placement',label:'Placement',color:0x4ecdc4,today:62,proj:{aggressive:93,moderate:78,bau:35,worst:15}},{id:'employment',label:'Employment',color:0x95cf95,today:45,proj:{aggressive:85,moderate:68,bau:30,worst:12}}],
  governance:[{id:'civic',label:'Civic Partic.',color:0xb0a0d0,today:42,proj:{aggressive:78,moderate:58,bau:35,worst:12}},{id:'charter',label:'Charter',color:0x4ecdc4,today:10,proj:{aggressive:92,moderate:55,bau:8,worst:0}},{id:'instrust',label:'Inst. Trust',color:0x5da5da,today:43,proj:{aggressive:72,moderate:56,bau:32,worst:18}},{id:'audit',label:'Audit Coverage',color:0xe8a838,today:10,proj:{aggressive:96,moderate:68,bau:15,worst:3}}],
  strategy:[{id:'personal',label:'Individual',color:0xe8636e,today:30,proj:{aggressive:88,moderate:58,bau:18,worst:6}},{id:'org',label:'Institutional',color:0x5da5da,today:35,proj:{aggressive:90,moderate:62,bau:22,worst:8}},{id:'systemic',label:'Systemic',color:0x4ecdc4,today:40,proj:{aggressive:86,moderate:65,bau:25,worst:10}}]
};
var VIZ_SUB_SUB_NODE_DATA={
...
window.VIZ_SYS=VIZ_SYS;
window.VIZ_SC_META=VIZ_SC_META;
window.VIZ_SUB_NODE_DATA=VIZ_SUB_NODE_DATA;
window.VIZ_SUB_SUB_NODE_DATA=VIZ_SUB_SUB_NODE_DATA;
...
(function(){
  ...
  s.src='js/chat-widget.js?v=20260810a';
  s.defer=true;
